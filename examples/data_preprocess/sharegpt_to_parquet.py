...
instruction_extra_simple = """<image>
You are a vision-language assistant. Your task is to answer the given question about an image. Structure your response using `<look>`, `<think>`, and end with `<answer>`.
...
instruction_thinking = """<image>
You are a vision-language assistant. Your task is to answer the given question about an image. Structure your response using `<think>`, and end with `<answer>`.
...
def main() -> None:
    ...
    if args.instruction_style == "strict":
        ...
        selected_instruction = instruction_thinking
    elif args.instruction_style == "normal":
        selected_instruction = instruction_normal
    elif args.instruction_style == "selected_simple":
        selected_instruction = instruction_simple
